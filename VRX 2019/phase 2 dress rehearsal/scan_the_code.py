...
lower_red = np.array([0,120,60])
upper_red = np.array([13,255,230])

lower_blue = np.array([85,219,73])
upper_blue = np.array([125,255,206])

lower_green = np.array([50,62,68])
upper_green = np.array([103,255,225])
